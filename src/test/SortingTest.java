...
public class SortingTest {
    ...
    private static Map<Class, Integer> timsTest(int times, int numsLen, boolean isPrint) {
        ...
        while (times-- > 0) {
            ...
            Class[] clas = new Class[] { BubbleSort.class, BucketSort.class, HeapSort.class, InsertionSort.class, MergeSort.class,
                    QuickSort.class, QuickSortWithMin.class, SelectionSort.class, ShellSort.class };
            // count of fast
    ...
    public static void main(String[] args) {
        Map<Class, Integer> fastTimesResult = timsTest(1, 10000, true);
